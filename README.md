...
* *Nota*: Si simplemente quieres aprovechar el layout hecho para dash, añade ```from Components.UIComponents.Main import initial_layout``` a tu código (o adapta la ruta), además de asegurarte de cargar también la carpeta ```assets``` de este repositorio a tu app de dash.
